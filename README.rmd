...
### To Do List
   ...
   3. DONE: Make custom seeds so that cases are always the same no matter how the sim study is specified.
   2. Add functions for plotting and making tables for output of `run_sim_study()`
   3. Add parallel capabilities (for replications only?)
   4. Run a large comparison and store results. 
